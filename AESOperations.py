...
def key_expansion(keyMatrix):
    ...
    while(counter <= 39):
        ...
        if(counter % 4 == 0):
            ...
            word[0], word[1], word[2], word[3] = sbox[int(word[1], 16)], sbox[int(
                word[2], 16)], sbox[int(word[3], 16)], sbox[int(word[0], 16)]
            ...
            keyMatrix[1].append(
                hex(int(keyMatrix[1][counter-4], 16) ^ int(word[1], 16)).replace("0x", ""))
            keyMatrix[2].append(
                hex(int(keyMatrix[2][counter-4], 16) ^ int(word[2], 16)).replace("0x", ""))
            keyMatrix[3].append(
            ...
            keyMatrix[0].append(hex(int(keyMatrix[0][counter-4], 16)
                                    ^ int(keyMatrix[0][counter-1], 16)).replace("0x", ""))
            keyMatrix[1].append(hex(int(keyMatrix[1][counter-4], 16)
                                    ^ int(keyMatrix[1][counter-1], 16)).replace("0x", ""))
            keyMatrix[2].append(hex(int(keyMatrix[2][counter-4], 16)
